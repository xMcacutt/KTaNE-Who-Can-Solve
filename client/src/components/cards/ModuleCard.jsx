...
function ModuleCard({
    ...
    const manualUrl = module.is_blacklisted ? `` : `https://ktane.timwi.de/redirect/#${encodedModuleName}`;
            ...
            <CardContent sx={{
                ...
                <Box sx={{
                    ...
                    <Box ml={5}>
                        ...
                        {module.is_blacklisted === true && (
                            <Stack>
                                <Typography variant="bebas" fontSize="1.5rem">{module.name}</Typography>
                                <Typography size="small" sx={{ pt: 0.35 }} color="#ff0000">THIS MODULE CONTAINS LARGE PORTIONS GENERATED BY AI</Typography>
                            </Stack>
                        )}
                ...
                >
                    {module.is_blacklisted && (
                        <Tooltip title={"AI"}>
                            <Box backgroundColor="#FF0000" sx={{ cursor: 'pointer', borderRadius: "50%", p: 0.5 }}>
                                <Box
                                    component={RobotIcon}
                                    sx={{
                                        height: 32,
