                ...
                <Grid container spacing={2} alignItems="stretch" direction="row">
                    <Grid item xs={12} md={9} size={6} flexGrow={1}>
                        <Box display="flex" flexDirection="column" gap={1} height="100%">
                            ...
                            {
                                module.is_blacklisted ? (
                                    <Typography variant="body2" color="#ff0000">{"THIS MODULE CONTAINS LARGE PORTIONS GENERATED BY AI"}</Typography>
                                ) : (
                            ...
                            <Box display="flex" flexWrap="wrap" gap={1} mt={1}>
                                ...
                                {module.is_blacklisted && (
                                    <Chip label={`AI Generated`} size="small" sx={{ backgroundColor: "#ff0000" }} />
                                )}
                                {module.type !== "Regular" && (
